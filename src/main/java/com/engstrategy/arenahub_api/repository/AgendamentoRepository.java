...
import com.engstrategy.arenahub_api.dto.arena.QuadraEstatisticaDTO;
...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Long>, JpaSpecificationExecutor<Agendamento> {
    ...
    @Query("SELECT new com.engstrategy.arenahub_api.dto.arena.QuadraEstatisticaDTO(q.nomeQuadra, COUNT(a)) " +
            "FROM Agendamento a " +
            "JOIN a.quadra q " +
