...
import com.engstrategy.arenahub_api.dto.arena.ArenaRatingInfo;
import com.engstrategy.arenahub_api.dto.quadra.QuadraRatingInfo;
import com.engstrategy.arenahub_api.model.Avaliacao;
...
public interface AvaliacaoRepository extends JpaRepository<Avaliacao, Long> {
    ...
    @Query("SELECT new com.engstrategy.arenahub_api.dto.arena.ArenaRatingInfo(AVG(av.nota), COUNT(av.id)) " +
            "FROM Avaliacao av " +
    ...
    @Query("SELECT new com.engstrategy.arenahub_api.dto.quadra.QuadraRatingInfo(av.agendamento.quadra.id, AVG(av.nota), COUNT(av.id)) " +
            "FROM Avaliacao av " +
