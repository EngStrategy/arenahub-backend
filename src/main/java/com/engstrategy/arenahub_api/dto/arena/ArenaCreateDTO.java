package com.engstrategy.arenahub_api.dto.arena;
...
public class ArenaCreateDTO {
    ...
    @Schema(description = "Formas de pagamento aceitas pela arena", example = "PIX, LOCAL, AMBOS")
    @NotNull(message = "Forma de pagamento é obrigatória")
    private FormaPagamento formaPagamento;

    @Schema(description = "Chave Pix da arena, caso a forma de pagamento seja PIX ou AMBOS", example = "username@example.com")
    private String chavePix;


    @Schema(description = "Tipo da chave Pix (CPF, CNPJ, EMAIL, TELEFONE, ALEATORIA)")
