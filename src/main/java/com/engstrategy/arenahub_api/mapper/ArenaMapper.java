package com.engstrategy.arenahub_api.mapper;

import com.engstrategy.arenahub_api.dto.arena.ArenaCreateDTO;
import com.engstrategy.arenahub_api.dto.arena.ArenaResponseDTO;
import com.engstrategy.arenahub_api.dto.quadra.HorarioFuncionamentoResponseDTO;
import com.engstrategy.arenahub_api.dto.quadra.IntervaloHorarioResponseDTO;
import com.engstrategy.arenahub_api.dto.quadra.QuadraResponseDTO;
import com.engstrategy.arenahub_api.model.Arena;
import com.engstrategy.arenahub_api.model.HorarioFuncionamento;
import com.engstrategy.arenahub_api.model.Quadra;
...
public class ArenaMapper {
    ...
    public Arena mapArenaCreateDtoToArena(ArenaCreateDTO arenaCreateDTO) {
        return Arena.builder()
                ...
                .formaPagamento(arenaCreateDTO.getFormaPagamento())
                .chavePix(arenaCreateDTO.getChavePix())
                .tipoChavePix(arenaCreateDTO.getTipoChavePix())
                .build();
    }
